export class GameOver4 extends Phaser.Scene {
    ...
    create ()
    {
        ...
        console.log(score+'   game over 4 cuatro   '+tiempo);
        ...
        refreshh.once('pointerup', function () {
            console.log('regresando a GAME 7  !');
        ...
        refreshh.once('pointerup', function () {
            console.log('regresando a escena game 7 !');
            //this.scene.start('Game7');
            this.scene.start('Game7');
        ...
        nextt.once('pointerup', function () {
            ...
            console.log('ingresando a esena animales marinos  !!!!!!!!!!');
        ...
        //this.add.text(400, 500, 'Click', { fontFamily: 'bebas', fontSize: 26, color: '#ffffff' }).setShadow(2, 2, "#333333", 2, false, true).setOrigin(0.5);
