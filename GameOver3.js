export class GameOver3 extends Phaser.Scene {
    ...
    create ()
    {
        ...
        console.log(score+'   **game over ****   '+tiempo);
        ...
        refreshh.once('pointerup', function () {
            console.log('regresando  a escena Nivel 2 !');
        ...
        nextt.once('pointerup', function () {
            ...
            console.log('ingresando a esena Game 7  !!!!!!!!!!');
